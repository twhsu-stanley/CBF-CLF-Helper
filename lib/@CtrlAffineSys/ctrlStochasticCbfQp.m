function [u, B, feas, comp_time] = ctrlStochasticCbfQp(obj, x, u_ref, sigma, verbose)
    %% Implementation of stochastic CBF-QP
    % Inputs:   x: state
    ...
    % CBF constraint.
    A = [-LgB];
    b = [LfB + scbf_correction + obj.params.cbf.rate * B];
